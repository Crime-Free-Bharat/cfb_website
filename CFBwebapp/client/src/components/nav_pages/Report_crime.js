      ...
      <div className='container mt-4'>
        <div className='row'>
          ...
          <div className='col-sm-12'>
            ...
            <form action='/report'>
              <div className='row'>
                <div className='col-6'>Category Of Complaints :-</div>
              ...
              <div className='row'>
                <div className='col-6'>
                  <select
                    ...
                    required>
                    <option style={{ background: "#c4c4c4" }}>
              ...
              <div className='row'>
                <div className='col-6'>Police Station :-</div>
                <div className='col-6'>Victim Image/Video :-</div>
              </div>
              ...
              <div className='row'>
                <div className='col-6'>
                  <select
                    ...
                    className='form-control'
                    onChange={handleInputs}>
                      <option  selected style={{ background: "#c4c4c4" }}>---Select---</option>
                    ...
                    <option disabled style={{ background: "#c4c4c4" }}>
                      District Central, District Courts Tis Hazari, Delhi-110
                      054.
                    </option>
                    ...
                    <option>
                      Old Delhi Railway Station (Railway Main Delhi)
                    </option>
                    ...
                    <option disabled style={{ background: "#c4c4c4" }}>
                      District New Delhi, District Courts Patiala House,
                      Delhi-110 001.
                    </option>
                    ...
                    <option disabled style={{ background: "#c4c4c4" }}>
                      District North-East, District Courts Karkardooma,
                      Delhi-110 032
                    </option>
                    ...
                    <option disabled style={{ background: "#c4c4c4" }}>
                      District Shahdara, District Courts Karkardooma, Delhi-110
                      032
                    </option>
              ...
              <div className='row'>
                <div className='col-12'>
                  <textarea
                    ...
                    className='form-control'
                    rows='5'
                    placeholder='report with Date and Village name'
                    name='victimReport'
          ...
          <div className='col-sm-12'>
            ...
            <form>
              <div className='row'>
                <div className='col-6'>Suspect Full Name :-</div>
                <div className='col-6'>Suspect Image :-</div>
              </div>
              <div className='row'>
                <div className='col-6'>
                  <input
