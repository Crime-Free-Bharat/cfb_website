                    ...
                    <div className="col-sm-12">
                        ...
                        <form >
                            <div className="row">
                                <div className="col-6">
                                    <select type="text" className="form-control" placeholder="Category of Complain">
                                        <option disabled select="true">Category of Complain</option>
                            ...
                            <div className="row" id="map" >
                                <div className="col-6">
                                    <input type="text" className="form-control" placeholder="Select State" id="autocompleteState" onClick={TestAutocomplete}/>  
                            ...
                            <div className="row">
                                <div className="col-12">
                                    <textarea type="text" className="form-control" rows="5" placeholder="report">
